...
while True:
    ...
    if ids is not None:
        ...
        aruco.drawAxis(frame, mtx, dist, rvec, tvec, 10)
        ...
        str_angleBias = "Target AngleBias angleX=%f angleY=%f"%(angle_x, angle_y) 
        cv2.putText(frame, str_angleBias, (0, 300), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
